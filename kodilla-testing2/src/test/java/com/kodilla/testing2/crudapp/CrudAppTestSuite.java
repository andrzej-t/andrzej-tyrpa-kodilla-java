...
public class CrudAppTestSuite {
    private final static String BASE_URL = "https://andrzej-t.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("andrzej.tyrpa@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Lukrecja113");
